...
const BOAT_FIELDS = [
  ...
  { path: 'hull.sideForceCoeff', kind: 'physics', unit: '', step: 0.05, labelEn: 'Hull side-force coeff.', labelPl: 'Współcz. siły bocznej kadłuba' },
  { path: 'hull.leewaySaturationDeg', kind: 'physics', unit: '°', step: 1, labelEn: 'Leeway saturation angle', labelPl: 'Kąt nasycenia znosu' },
  { path: 'hull.leewayMushingCoeff', kind: 'physics', unit: '', step: 0.5, labelEn: 'Post-saturation mushing coeff.', labelPl: 'Współcz. tłumienia po nasyceniu' },
  ...
  { path: 'sail.ceBrailShift', kind: 'physics', unit: '', step: 0.01, labelEn: 'CE shift from windward brail', labelPl: 'Przesunięcie CE przez brajdę nawietrzną' },
